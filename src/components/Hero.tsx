...
const Hero = () => {
  return (
    <section id="hero" className="relative min-h-[48rem] h-[100svh] flex <section id="hero" className="relative min-h-[48rem] h-[100svh] flex items-center justify-center overflow-hidden"> justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-28 md:pt-32 pb-20">
        ...
        <h1 className="font-display text-4xl md:text-7xl lg:text-8xl font-bold text-foreground leading-[1.05] mb-6 md:mb-8 text-balance">
          The Premier{" "}
